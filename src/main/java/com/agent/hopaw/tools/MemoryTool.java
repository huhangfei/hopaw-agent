...
public class MemoryTool implements AgentTool {
    ...
    public String queryGlobalMemory(){
        return longTermMemoryService.getMemoryTree(LongTermMemoryService.GLOBAL_IDENTITY);
    }
    @Tool("查询智能体记忆分类。")
    public String queryGlobalRootMemory(){
    ...
    public String deleteGlobalMemory(Long id){
