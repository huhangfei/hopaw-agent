...
//                }
    ...
    public class MemoryTool{
        ...
        @Tool(name = "memory_queryById", value = {"按Id查询用户记忆", "查询用户记忆详细内容,根据指定Id查询"},searchBehavior = SearchBehavior.ALWAYS_VISIBLE)
        ...
        @Tool(name = "memory_deleteById", value = {"按Id删除用户记忆", "删除用户记忆内容，根据指定id删除"},searchBehavior = SearchBehavior.ALWAYS_VISIBLE)
