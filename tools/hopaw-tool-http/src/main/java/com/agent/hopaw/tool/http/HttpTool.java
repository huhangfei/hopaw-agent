...
public class HttpTool implements AgentTool {
    ...
    @Tool(name = "http_doGet", value = {"发送HTTP GET请求", "发送HTTP GET请求，用于查询接口数据"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.PARAM_REQUIRE_APPROVAL)
    @Tool(name = "http_doPost", value = {"发送HTTP POST请求", "发送HTTP POST请求，用于提交数据或创建资源"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.PARAM_REQUIRE_APPROVAL)
    @Tool(name = "http_doPut", value = {"发送HTTP PUT请求", "发送HTTP PUT请求，用于更新资源"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.PARAM_REQUIRE_APPROVAL)
    @Tool(name = "http_doDelete", value = {"发送HTTP DELETE请求", "发送HTTP DELETE请求，用于删除资源"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.PARAM_REQUIRE_APPROVAL)
    @Tool(name = "http_doPatch", value = {"发送HTTP PATCH请求", "发送HTTP PATCH请求，用于部分更新资源"})
    ...
    @Tool(name = "http_doHead", value = {"发送HTTP HEAD请求", "发送HTTP HEAD请求，用于获取响应头信息"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.SAFE)
    @Tool(name = "http_doOptions", value = {"发送HTTP OPTIONS请求", "发送HTTP OPTIONS请求，用于查询支持的HTTP方法"})
    ...
    @ToolSecurityLevel(ToolSecurityLevel.Level.PARAM_REQUIRE_APPROVAL)
    @Tool(name = "http_doRequest", value = {"发送自定义HTTP请求", "发送自定义方法的HTTP请求，支持任意HTTP方法"})
