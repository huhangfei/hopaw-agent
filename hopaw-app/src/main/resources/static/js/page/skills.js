...
function renderCards(skills) {
    ...
    skills.forEach(function(s) {
        ...
        html += '<div class="skill-card">' +
            ...
            '</button>' +
            '<button class="btn-card btn-export" onclick="exportSkill(\'' + escapeAttr(s.folderName) + '\')" title="导出">' +
...
function exportSkill(folderName) {
    window.location.href = '/skills/api/export/' + encodeURIComponent(folderName);
}