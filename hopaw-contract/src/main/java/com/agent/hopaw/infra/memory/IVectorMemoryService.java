...
public interface IVectorMemoryService {
    ...
    String store(String content, String sessionId, Long agentId, String userId, VectorMemoryTypeEnum memoryType, LocalDateTime timestamp);

    void storeBatch(List<String> contents,String sessionId, Long agentId, String userId, VectorMemoryTypeEnum memoryType, LocalDateTime timestamp);
